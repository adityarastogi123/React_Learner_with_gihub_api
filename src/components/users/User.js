...
const User= ({match})=> {
    ...
    useEffect(()=>{
        githubContext.getUser(match.params.xyz)
        githubContext.getUserRepos(match.params.xyz)
        // eslint-disable-next-line
    },[])

    // componentDidMount(){
    //     getUser(this.props.match.params.xyz)
    //     getUserRepos(this.props.match.params.xyz)
    // }
